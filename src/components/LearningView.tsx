...
const LearningView: React.FC<LearningViewProps> = ({ course, onMarkComplete, quizProgress, onUpdateQuizProgress, onCourseUpdate }) => {
    ...
    const handleSubmitQuiz = async () => {
        ...
        try {
            const response = await axios.post<QuizCompletionResponse>('http://learn-sphere-backend-eight.vercel.app/api/quiz/complete', {
                userId: clerkUser.id,
                courseId: course.id,
                chapterIndex: activeLesson.chap,
                lessonIndex: activeLesson.less,
    ...
    const handleTryAgain = async () => {
        ...
        try {
            await axios.post('http://learn-sphere-backend-eight.vercel.app/api/quiz/regenerate', {
                userId: clerkUser.id,
                courseId: course.id,
                chapterIndex: activeLesson.chap,
                lessonIndex: activeLesson.less
